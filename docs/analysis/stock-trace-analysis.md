> [docs](../README.md) / [analysis](README.md) / stock-trace-analysis.md
...
See [tgobjptrevent-class.md](../protocol/tgobjptrevent-class.md) for full analysis.
...
- [wire-format-spec.md](../protocol/wire-format-spec.md) — Complete wire format reference
- [ship-death-lifecycle.md](../networking/ship-death-lifecycle.md) — Ship death/respawn sequence
- [collision-effect-protocol.md](../protocol/collision-effect-protocol.md) — CollisionEffect (0x15) protocol
- [pythonevent-wire-format.md](../protocol/pythonevent-wire-format.md) — PythonEvent (0x06) wire format
- [message-trace-vs-packet-trace.md](../protocol/message-trace-vs-packet-trace.md) — Earlier stock-dedi cross-reference
