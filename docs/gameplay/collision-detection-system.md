...
- [collision-effect-protocol.md](../protocol/collision-effect-protocol.md) -- Network protocol for opcode 0x15
- [damage-system.md](damage-system.md) -- Damage pipeline (collision -> hull/subsystem damage)
