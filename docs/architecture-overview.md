...
See [binary-patching-primer.md](binary-patching-primer.md) for a detailed explanation with examples.
...
See [alby-rules-cipher-analysis.md](alby-rules-cipher-analysis.md) for the encryption details and [wire-format-spec.md](wire-format-spec.md) for the packet format.
