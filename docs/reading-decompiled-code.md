...
- Cross-reference with known offsets in [dedicated-server.md](dedicated-server.md)
...
To identify which function is being called, you need to know the vtable layout. Check the agent memory or [function-map.md](function-map.md) for known vtables.
