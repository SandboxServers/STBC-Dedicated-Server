> [docs](../README.md) / [guides](README.md) / lessons-learned.md
...
- **VEH crash recovery creates zombie objects**: Vectored Exception Handlers that redirect
  ...
  See [docs/veh-cascade-triage.md](../analysis/veh-cascade-triage.md) for full analysis.
...
- **StateUpdate flags are direction-dependent**: C->S always uses 0x80 (WPN), S->C always uses
  ...
  See [docs/message-trace-vs-packet-trace.md](../protocol/message-trace-vs-packet-trace.md).
- **Empty StateUpdates caused disconnect (FIXED)**: Server was sending flags=0x00 because
  ...
  See [docs/empty-stateupdate-root-cause.md](../analysis/empty-stateupdate-root-cause.md).
