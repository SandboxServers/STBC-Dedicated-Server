...
SCREEN_PIXEL_WIDTH		= 1280.0
SCREEN_PIXEL_HEIGHT		= 1024.0

DEFAULT_ST_INDENT_HORIZ	= 5		/ SCREEN_PIXEL_WIDTH
DEFAULT_ST_INDENT_VERT	= 3		/ SCREEN_PIXEL_HEIGHT
MARKER_INDENT_HORIZ		= 2		/ SCREEN_PIXEL_WIDTH
TAC_WEAPONS_CTRL_INDENT_HORIZ = 6 / SCREEN_PIXEL_WIDTH
...
POWER_GAUGE_WIDTH			= 36.0 / 1280.0
POWER_GAUGE_HEIGHT			= 104.0 / 1024.0
...
#	Return:	none
###############################################################################
def LoadLCARS_1280(LCARS = None):
	# If no Icon Group passed in, create one and add to icon manager.	
	if LCARS is None:
		LCARS = App.g_kIconManager.CreateIconGroup("LCARS_1280")
...
###############################################################################
def Switch():
	App.globals.DEFAULT_ST_INDENT_HORIZ	= 5		/ SCREEN_PIXEL_WIDTH
	App.globals.DEFAULT_ST_INDENT_VERT	= 3		/ SCREEN_PIXEL_HEIGHT
	App.globals.MARKER_INDENT_HORIZ		= 2		/ SCREEN_PIXEL_WIDTH
	App.globals.TAC_WEAPONS_CTRL_INDENT_HORIZ = 6 / SCREEN_PIXEL_WIDTH
