...
SCREEN_PIXEL_WIDTH		= 1024.0
SCREEN_PIXEL_HEIGHT		= 768.0

DEFAULT_ST_INDENT_HORIZ	= 4		/ SCREEN_PIXEL_WIDTH
...
#	Return:	none
###############################################################################
def LoadLCARS_1024(LCARS = None):
	# If no Icon Group passed in, create one and add to icon manager.	
	if LCARS is None:
		LCARS = App.g_kIconManager.CreateIconGroup("LCARS_1024")
...
###############################################################################
def Switch():
	App.globals.DEFAULT_ST_INDENT_HORIZ	= 4		/ SCREEN_PIXEL_WIDTH
