...
ShieldGenerator.SetMaxShields(ShieldGenerator.BOTTOM_SHIELDS, 1100.000000)
...
WarpCore.SetMaxCondition(3200.000000)
...
ImpulseEngines.SetMaxSpeed(5.400000)
...
ForwardBeam.SetRechargeRate(0.200000)
...
AftBeam.SetRechargeRate(0.200000)
