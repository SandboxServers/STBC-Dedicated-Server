...
- [docs/collision-effect-protocol.md](docs/collision-effect-protocol.md) - Opcode 0x15 wire format, CollisionEvent class layout (0x44 bytes), handler validation, send/receive paths
